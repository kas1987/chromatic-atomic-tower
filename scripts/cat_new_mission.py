...
def main() -> int:
    ...
    parser.add_argument('--id', required=True, help='Mission ID, e.g. MP-CAT-S001-4C01')
    ...
    if args.allow_legacy_id:
        ...
        if not allowed:
            parser.error('invalid mission id; expected MP-CAT-S001-4C01 style or a grandfathered legacy id')
    else:
